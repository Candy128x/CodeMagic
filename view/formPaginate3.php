...
<h5>#Paginate3 fixed-PrettyGood</h5>
...
<th class='styOprnIUSD'>Operation &nbsp
<a class='btn btn-primary btn-sm' href='<?php echo $projPath.'/view/formInsert.php'; ?>' 
 data-toggle='tooltip' data-placement='left' title='Insert Data..'>
